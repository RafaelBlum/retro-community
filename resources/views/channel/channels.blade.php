                ...
                <div class="md:py-20 py-12 up">
                    <div class="mx-auto max-w-5xl md:pb-16 pb-10 text-center">
                        ...
                        <h1 class="font-bold font-heading leading-tighter tracking-tighter mb-4 md:text-6xl text-5xl">
                            ...
                            <span class="highlight text-accent">Hall dos Conquistadores</span>
                        </h1>
                        <div class="mx-auto max-w-3xl">
                            <p class="text-muted text-xl mb-6">
                                Bem-vindo à <a href="{{route('app.home')}}" class="text-purple-600 hover:underline">Hall
                                    dos Conquistadores</a>,
                                sua comunidade dedicada aos clássicos dos games retrô! A nostalgia dos anos 80 e 90, uma
                                época de ouro que foi incrível para muitas pessoas.
                                Explore nosso blog repleto de artigos atualizados sobre lives, gameplays, eventos entre
                                outros conteúdos magnificos.
                            </p>
                ...
                <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    @foreach($channels as $channel)
                        <div class="text-center text-gray-500">
                            <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="{{Storage::url($channel->brand)}}"
                                alt="Bonnie Avatar">
                            ...
                            <ul class="flex justify-center mt-4 space-x-4">
                                <li>
                                    <a href="{{'https://www.youtube.com/@' . $channel->link}}"
                                        class="text-[#ea4c89] hover:text-gray-900">
                                        <svg class="h-4 mt-1" viewBox="0 0 132 29" fill="currentColor"
