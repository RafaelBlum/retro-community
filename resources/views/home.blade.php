            ...
            <div class="flex flex-col items-center">
                ...
                @if($posts->count() != 0)
                        ...
                        @else
                            ...
                            @if($posts->count() <= 3)
                                <a href="#" class="mt-6 inline-block flex-none cursor-pointer rounded-[5px] border-0 bg-[#f7d046] px-[1.688rem] py-[0.813rem] hover:bg-[#FAC819] transition-colors font-[Manrope,_sans-serif] text-base font-semibold capitalize leading-[1.313rem] text-black antialiased [transition:color_0.25s_ease_0s] hover:[box-shadow:rgb(0,_0,_0)_0px_0px]"> Veja mais </a>
                            @endif
                    @endif
