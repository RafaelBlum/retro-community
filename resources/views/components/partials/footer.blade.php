<footer class="bg-white dark:bg-gray-800">
    <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
        <div class="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
            <div>
                <a href="{{route('app.landing')}}" class="flex items-center mb-6">
                    ...
                    <h3 class="text-sm font-semibold text-gray-900 uppercase dark:text-white">{{config('app.name')}}</h3>
                </a>
        ...
        <div class="text-center down">
            ...
            <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© {{date('Y')}} {{config('app.name')}}. Todos direitos reservados. Desenvolvido por <a href="{{config('dev.github')}}" target="_blank" class="text-purple-600 hover:underline dark:text-purple-500">{{ config('dev.developer') }}</a> <a href="{{config('dev.github')}}" target="_blank" class="text-purple-600 hover:underline dark:text-purple-500">Rafael Blum</a>.
                </span>
            <ul class="flex justify-center mt-5 space-x-5">
                <li>
                    <a href="https://www.instagram.com/rafablum_/" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                ...
                <li>
                    <a href="https://www.linkedin.com/in/rafael-b-237133114/" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                        <svg class="w-5 h-5" viewBox="0 0 64 64" aria-labelledby="title" aria-describedby="desc" role="img" xmlns:xlink="http://www.w3.org/1999/xlink"><path data-name="layer1" fill="currentColor" d="M1.15 21.7h13V61h-13zm46.55-1.3c-5.7 0-9.1 2.1-12.7 6.7v-5.4H22V61h13.1V39.7c0-4.5 2.3-8.9 7.5-8.9s8.3 4.4 8.3 8.8V61H64V38.7c0-15.5-10.5-18.3-16.3-18.3zM7.7 2.6C3.4 2.6 0 5.7 0 9.5s3.4 6.9 7.7 6.9 7.7-3.1 7.7-6.9S12 2.6 7.7 2.6z"></path></svg>
                    </a>
                </li>
            </ul>
        </div>
