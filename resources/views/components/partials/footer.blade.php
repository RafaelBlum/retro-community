<footer class="bg-white dark:bg-dark text-gray-900 dark:text-white">
    <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
        ...
        <div class="text-center down">
            ...
            <span class="block text-sm text-center text-gray-500">© {{date('Y')}} {{config('app.name')}}. Todos direitos reservados. Desenvolvido por <a href="{{config('dev.github')}}" target="_blank" class="text-purple-600 hover:underline">{{ config('dev.developer') }}</a> <a href="{{config('dev.github')}}" target="_blank" class="text-purple-600 hover:underline">Rafael Blum</a>.
                </span>
            <ul class="flex justify-center mt-5 space-x-5">
                <li>
                    <a href="https://www.instagram.com/rafablum_/" target="_blank" class="text-gray-500 hover:text-gray-900">
                ...
                <li>
                    <a href="https://www.facebook.com/rafael.blum.3" target="_blank" class="text-gray-500 hover:text-gray-900">
                ...
                <li>
                    <a href="https://github.com/RafaelBlum" target="_blank" class="text-gray-500 hover:text-gray-900">
                ...
                <li>
                    <a href="https://www.linkedin.com/in/rafael-b-237133114/" target="_blank" class="text-gray-500 hover:text-gray-900">
                ...
                <li>
                    <a href="https://www.youtube.com/@rafablum" target="_blank" class="text-gray-500 hover:text-gray-900">
