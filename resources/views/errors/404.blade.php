...
<body class="font-sans antialiased bg-white dark:bg-slate-800 text-gray-900 dark:text-white bg-no-repeat bg-cover bg-opacity-200" style="overflow: hidden;">
        ...
        <div class="py-8 px-8 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
                ...
                @if ($exception->getMessage())
                    <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Desculpe, {{ $exception->getMessage() }} </p>
