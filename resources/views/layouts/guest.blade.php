...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased bg-dark">
        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-dark">
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-blue-950/50 border border-primary/30 shadow-[0_0_15px_rgba(0,0,0,0.5)] overflow-hidden sm:rounded-lg backdrop-blur-sm">
                {{ $slot }}
            </div>
        </div>
    </body>
