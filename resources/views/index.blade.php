        ...
        <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a href="{{route('app.landing')}}" class="flex items-center">
                    <img src="{{asset('images/channels/zerandojogos_profile.jpg')}}" class="h-6 mr-3 sm:h-9 rounded-full" alt="Landwind Logo" />
                ...
                <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="{{route('app.home')}}" class="block py-2 pl-3 pr-4 text-white bg-purple-700 rounded lg:bg-transparent lg:text-purple-700 lg:p-0 dark:text-white" aria-current="page">
                                Home
                            </a>
                        </li>
                        <li>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">{{env('app_name')}}<br>Informações, Games & hacks.</h1>
                        ...
                        <article class="test max-w-xs">
                            ...
                            <div class="flex items-center gap-x-4 text-xs">
                                ...
                                <form method="POST" action="{{route('posts.destroy', ['post'=> $post])}}">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="relative z-10 rounded-full bg-amber-900 px-2 py-1 font-medium text-gray-600 dark:text-white hover:bg-amber-800">Delete</button>
                                </form>
                                <a href="{{route('posts.edit', ['post'=> $post])}}" class="relative z-10 rounded-full bg-blue-500 px-2 py-1 font-medium text-gray-600 dark:text-white hover:bg-amber-800">Editar</a>
                            </div>
    ...
    <footer class="bg-white dark:bg-gray-800">
        <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            <div class="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
                <div>
                    <h3 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">{{env('app_name')}}</h3>
            ...
            <div class="text-center">
                ...
                <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© {{date('Y')}} {{env('app_name')}}. All Rights Reserved. Built with <a href="https://flowbite.com" class="text-purple-600 hover:underline dark:text-purple-500">Rafael Blum</a> and <a href="https://tailwindcss.com" class="text-purple-600 hover:underline dark:text-purple-500">Tailwind CSS</a>.
                </span>
