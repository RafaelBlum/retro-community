                        ...
                        <div class="mx-auto max-w-5xl md:pb-16 pb-10 text-center">
                            ...
                            <div class="mx-auto max-w-3xl">
                                <p class="text-muted text-xl mb-6">
                                    ...
                                    sua comunidade dedicada aos clássicos dos games retrô! Explore nosso blog repleto de
                                    artigos atualizados sobre gameplays, eventos e análises detalhadas.
                                </p>
                        ...
                        <div>
                            <div class="m-auto max-w-5xl">
                                <img alt="Caos Image" class="up mx-auto w-full rounded-md" loading="eager"
                                     ...
                                     crossorigin="anonymous" decoding="async" height="576" referrerpolicy="no-referrer"
                                     srcset="https://images.unsplash.com/photo-1559136555-9303baea8ebd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&q=80&h=225 400w,
                                     https://images.unsplash.com/photo-1559136555-9303baea8ebd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=768&q=80&h=432 768w,
                                     https://images.unsplash.com/photo-1559136555-9303baea8ebd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1024&q=80&h=576 1024w,
                                     https://images.unsplash.com/photo-1559136555-9303baea8ebd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2040&q=80&h=1147 2040w,
                                     https://images.unsplash.com/photo-1559136555-9303baea8ebd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2048&q=80&h=1152 2048w"
            ...
            <div class="relative mx-auto px-4 lg:py-20 md:px-6 md:py-16 py-12 text-default max-w-6xl">
                ...
                <div class="flex justify-center -m-4 flex-wrap text-center">
                    <div class="w-full text-center md:border-r md:last:border-none md:w-1/4 min-w-[220px] p-4 sm:w-1/2">
                        <div class="font-bold font-heading lg:text-5xl text-[2.6rem] text-primary xl:text-6xl">4</div>
                    ...
                    <div class="w-full text-center md:border-r md:last:border-none md:w-1/4 min-w-[220px] p-4 sm:w-1/2">
                        <div class="font-bold font-heading lg:text-5xl text-[2.6rem] text-primary xl:text-6xl">12</div>
