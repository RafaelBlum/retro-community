    ...
    <section class="bg-white dark:bg-slate-900 py-20">
        <div class="max-w-3xl px-4 mx-auto text-center">
            ...
            <p class="text-gray-600 dark:text-gray-300 text-lg leading-relaxed mb-12">
                A <a href="{{route('app.home')}}" class="text-purple-600 hover:underline font-semibold">Hall dos Conquistadores</a> é uma comunidade dedicada aos clássicos dos games retrô.
            ...
            <div class="grid gap-6 sm:grid-cols-2 text-left">
                <div class="p-6 rounded-2xl bg-gray-50 dark:bg-slate-800">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Tire suas dúvidas sobre o funcionamento da plataforma e como participar da comunidade.</p>
                </div>
                ...
                <div class="p-6 rounded-2xl bg-gray-50 dark:bg-slate-800">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Saiba como cadastrar seu canal YouTube na plataforma e fazer parte da comunidade.</p>
                </div>
                ...
                <div class="p-6 rounded-2xl bg-gray-50 dark:bg-slate-800">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Precisa recuperar acesso ou reportar um problema com sua conta? Fale conosco.</p>
                </div>
                ...
                <div class="p-6 rounded-2xl bg-gray-50 dark:bg-slate-800">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Encontrou conteúdo inadequado? Nos ajude a manter a comunidade segura.</p>
                </div>
            </div>
        </div>
    </section>
