<x-layout>
        ...
        <div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
            <div class="flex flex-col items-center text-gray-900 dark:text-white">
                ...
                <p class="mb-8 font-light lg:text-xl">
                    Bem-vindo à <a href="{{route('app.home')}}" class="text-purple-600 dark:text-purple-500 hover:underline">Retrô Community</a>, sua comunidade dedicada aos clássicos dos games retrô! Explore nosso blog repleto de artigos atualizados sobre gameplays, eventos e análises detalhadas.
                </p>
                <p class="mb-8 font-light lg:text-xl">
    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="max-w-screen-xl mx-auto px-4 py-8 lg:px-6 lg:py-16">
            <div class="max-w-screen-sm mx-auto text-center">
                ...
                <img src="/images/brandname/favicon-retrocommunity.png" class="w-16 h-16 p-[0.1875rem] rounded-full ring-1 ring-slate-900/10 shadow overflow-hidden mx-auto dark:bg-indigo-500 dark:ring-white/20" alt="image description">
            </div>
        </div>
    </section>
