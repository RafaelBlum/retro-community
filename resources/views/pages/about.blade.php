    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
            <div class="flex flex-col items-center text-gray-900 dark:text-white">
                ...
                <p class="mb-8 font-light lg:text-xl">
                    Prepare-se para uma viagem no tempo através dos mundos pixelizados que capturaram nossa imaginação, enquanto celebramos a magia duradoura dos games retrô. Junte-se à Retrô Community, onde o passado e o presente se encontram em uma comunidade apaixonada por videogames clássicos.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div class="max-w-screen-sm mx-auto text-center">
                <h2 class="mb-4 text-3xl font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white">Desenvolvido por</h2>
                <p class="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">{{config('app.name')}}</p>
                <a href="#" class="text-white mt-6 bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800">
