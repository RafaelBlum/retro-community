                ...
                <div class="mx-auto px-4 max-w-7xl sm:px-6">
                    ...
                    <div class="md:py-20 py-12 up">
                        <div class="mx-auto max-w-5xl md:pb-16 pb-10 text-center">
                            <p class="font-bold dark:text-blue-200 text-base text-secondary tracking-wide uppercase">Sobre nossas políticas</p>
                            <h1 class="font-bold font-heading leading-tighter tracking-tighter mb-4 dark:text-gray-200 md:text-6xl text-5xl">
                                ...
                                <span class="dir max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">{{ config('app.name') }}</span></h1>
                            <div class="mx-auto max-w-3xl">
                                <p class="text-muted text-xl dark:text-slate-300 mb-6">
                                    Bem-vindo as politicas e privacidade de uso da <a href="{{route('app.home')}}" class="text-purple-600 dark:text-purple-500 hover:underline">Retrô Community</a>,
                        ...
                        <div class="mx-auto max-w-5xl md:pb-16 pb-10 mt-16 text-justify up text-gray-900 dark:text-white">
                            <p class="mb-4">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Informações coletadas</h3>
                            <p class="mb-4">
                                Na <a href="{{route('app.home')}}" class="text-purple-600 dark:text-purple-500 hover:underline">Retrô Community</a>,
                            ...
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Seus direitos</h3>
                            <p class="mb-4">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Segurança</h3>
                            <p class="mb-4">
                                Estamos comprometidos com a segurança dos seus dados, implementando criptografia e padrões regulares de segurança.
                            </p>

                            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Responsabilidades</h3>
                            <p class="mb-4">
                                Toda e qualquer informação postada na <a href="{{route('app.home')}}" class="text-purple-600 dark:text-purple-500 hover:underline">Retrô Community</a>
                            ...
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Privacidade das crianças</h3>
                            <p class="mb-4">
                                O <a href="{{route('app.home')}}" class="text-purple-600 dark:text-purple-500 hover:underline">Retrô Community</a> é destinado ao uso por indivíduos
                            ...
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Alterações na Política de Privacidade</h3>
                            <p class="mb-4">
                                Podemos modificar esta política a qualquer momento. O uso contínuo do Preline significa aceitação dessas mudanças.
                            </p>

                            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Contate-nos</h3>
                            <p class="mb-4">
                                Para dúvidas sobre esta Política de Privacidade ou nossas práticas de privacidade, entre em contato conosco pelo
                                <a href="{{route('app.home')}}" class="text-purple-600 dark:text-purple-500 hover:underline">SUPORTE</a> em nosso site.
                            </p>

                            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Acordo</h3>
                            <p class="mb-4">
                                Ao utilizar os serviços da <a href="{{route('app.home')}}" class="text-purple-600 dark:text-purple-500 hover:underline">Retrô Community</a>,
                                você reconhece que entendeu e concorda com esta Política de Privacidade.
                            </p>

                            <h3 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Alterações de privacidade</h3>
                            <p class="mb-4">
