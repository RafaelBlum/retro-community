                ...
                <div class="mx-auto px-4 max-w-7xl sm:px-6">
                    ...
                    <div class="md:py-20 py-12 up">
                        <div class="mx-auto max-w-5xl md:pb-16 pb-10 text-center">
                            ...
                            <div class="mx-auto max-w-3xl">
                                <p class="text-muted text-xl mb-6">
                                    Bem-vindo as politicas e privacidade de uso da <a href="{{route('app.home')}}" class="text-purple-600 hover:underline">Hall dos Conquistadores</a>,
                        ...
                        <div class="mx-auto max-w-5xl md:pb-16 pb-10 mt-16 text-justify up text-gray-900">
                            ...
                            <p class="mb-4">
                                Na <a href="{{route('app.home')}}" class="text-purple-600 hover:underline">Hall dos Conquistadores</a>,
                            ...
                            <p class="mb-4">
                                Toda e qualquer informação postada na <a href="{{route('app.home')}}" class="text-purple-600 hover:underline">Hall dos Conquistadores</a>
                            ...
                            <p class="mb-4">
                                O <a href="{{route('app.home')}}" class="text-purple-600 hover:underline">Hall dos Conquistadores</a> é destinado ao uso por indivíduos
                            ...
                            <p class="mb-4">
                                Ao utilizar os serviços da <a href="{{route('app.home')}}" class="text-purple-600 hover:underline">Hall dos Conquistadores</a>,
